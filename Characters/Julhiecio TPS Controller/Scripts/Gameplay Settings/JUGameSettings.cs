    ...
    public class JUGameSettings : MonoBehaviour
    {
        ...
        public static float RenderScale
        {
            ...
            set
            {
                ...
                targetResolution.refreshRateRatio = currentResolution.refreshRateRatio;

                Screen.SetResolution(targetResolution.width, targetResolution.height, FullScreenMode.FullScreenWindow, targetResolution.refreshRateRatio);
