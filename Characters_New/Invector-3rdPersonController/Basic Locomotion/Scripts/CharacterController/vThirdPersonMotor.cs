...
namespace Invector.vCharacterController
{
    ...
    public class vThirdPersonMotor : vCharacter, vIAnimatorStateInfoController
    {
        ...
        public virtual void ApplyAirMovement()
        {
            ...
            targetVelocity.y = _rigidbody.velocity.y;
            //空中限速
            targetVelocity.x = Mathf.Max(Mathf.Min(targetVelocity.x, 5f), -5);
            targetVelocity.y = Mathf.Max(Mathf.Min(targetVelocity.y, 5f), -5);
            targetVelocity.z = Mathf.Max(Mathf.Min(targetVelocity.z, 5f), -5);
